        ...
        if(!f.exists()){
            ...
            if(jar){
                ...
                for(String s : UtilEditor.getCheminImage(UtilEditor.ImageType.OBJET)){
                    UtilEditor.copierColler(new File("src/images/objets/" + s),new File(urlDossier + "/images/objets/" + s));
                }
                for(String s : UtilEditor.getCheminImage(UtilEditor.ImageType.SALLE)){
                    UtilEditor.copierColler(new File("src/images/salles/" + s),new File(urlDossier + "/images/salles/" + s));
                }
            }
        }
